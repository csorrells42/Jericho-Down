...
- Session playback methods in `src/EqualizerWindow.xaml.cs` until the UI controller is split out.
...
- NAudio routing from the Jericho Down app for sidecar WAV output.
- The Jericho Down app owns UI selection, deletion confirmation, and recording transport commands.
